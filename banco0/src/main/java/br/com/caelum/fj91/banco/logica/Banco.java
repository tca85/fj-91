...
public class Banco {
	 ...
	 * 
	 * @param campoNome
	 *            Recebe valor digitado no formulário com o nome.
	 * @param campoCpf
	 *            Recebe valor digitado no formulário com o cpf.
	...
	public Cliente registraCliente(String campoNome, String campoCpf) throws SQLException {
		// recebe os dados de um formulário, cria um cliente e guarda no banco
		// de dados
	 ...
	 * 
	 * @param titular
	 *            Cliente titular da conta. Já deve ter sido aprovado na
	 *            consulta ao Serasa.
	 * @param numero
	 *            Número da conta
